...
const Hero: FC<Props> = (props) => {
    return (
            ...
            <div className="w-full 1000px:flex items-center ">
                {/* here */}
                <div className="absolute top-[180px] 1000px:top-[unset] 1500px:h-[700px] 1500:w-[700px] 1100px:h-[600px] 1100px:w-[600px] h-[50vh] w-[50vh] hero_animation rounded">
                    ...
                    <div className="1000px:w-[60%] flex flex-col items-center 1000px:mt-[0px] text-center 1000px:text-left mt-[150px]">
                        ...
                        <br />
                        <p className="dark:text-[#edfff4] text-[-#00000ac] font-Josefin font-[600] text-[18px] 1500px:!w-[55%] 1100px:!w-[78%]">
                        ...
                        <div className="1500px:w-[55%] 1100px:w-[78%] w-[90%] flex items-center">
                            <img
                                src="https://edemy-react.hibootstrap.com/images/banner/client-3.jpg"
                                alt=""
                                className="rounded-full"
                            />
                            <img
                                src="https://edemy-react.hibootstrap.com/images/banner/client-1.jpg"
                                alt=""
                                className="rounded-full ml-[-20px]"
                            />
                            <img
                                src="https://edemy-react.hibootstrap.com/images/banner/client-2.jpg"
                                alt=""
                                className="rounded-full ml-[-20px]"
                            />
